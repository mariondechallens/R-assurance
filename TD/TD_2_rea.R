...
## 1. ----
dept=readShapeSpatial("C:/Users/Admin/Documents/Centrale Paris/3A/OMA/Réassurance/TD 2/DEPARTEMENT",proj4string=CRS("+init=epsg:2154"))
...
gbm.perf(gbm1) # au bout de combien d'arbres on converge ?
...
# plus inégalitaire donc plus différenciant entre les variables donc meilleur modèle
